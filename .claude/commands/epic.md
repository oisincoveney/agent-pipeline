...
- review: codex CLI profile=pipeline-thermo-nuclear-reviewer command=`codex exec --json -C <repo-root> --dangerously-bypass-approvals-and-sandbox --skip-git-repo-check <node prompt>` needs=merge
